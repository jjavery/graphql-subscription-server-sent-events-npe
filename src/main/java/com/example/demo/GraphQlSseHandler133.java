/*
 * Bug-fixed 1.3.3 version of GraphQlSseHandler.java copied from this commit:
...
//  package org.springframework.graphql.server.webmvc;
  ...
  * @since 1.3.0
  */
 public class GraphQlSseHandler133 extends GraphQlSseHandler {

     private final IdGenerator idGenerator = new AlternativeJdkIdGenerator();


     public GraphQlSseHandler133(WebGraphQlHandler graphQlHandler) {
